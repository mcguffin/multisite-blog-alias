...
You can can either go into the Support forum, or in the [WP Blog Alias Repository](https://github.com//wp-blog-alias).

= I'd like to suggest a feature. Where should I post it? =

I personally prefer GitHub. The plugin code is here: [GitHub](https://github.com//wp-blog-alias)
(See above as well.)
...
3. type `git clone git@github.com:/wp-blog-alias.git`
...
Either post it on the [GitHub-repo](https://github.com//wp-blog-alias) or—if you cloned the repository—send me a pull request.
